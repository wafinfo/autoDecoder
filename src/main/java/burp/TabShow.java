...
public class TabShow {
    ...
    public TabShow() {
        ...
        saveButton.addActionListener(e -> onChange());
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        rootPanel.setLayout(new GridLayoutManager(9, 3, new Insets(10, 10, 10, 5), -1, -1));
        ...
        address.setText("");
        rootPanel.add(address, new GridConstraints(8, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        saveButton = new JButton();
        saveButton.setText("Save");
        rootPanel.add(saveButton, new GridConstraints(8, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        rootPanel.add(label1, new GridConstraints(7, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        customFlag = new JTextField();
        customFlag.setText("");
        rootPanel.add(customFlag, new GridConstraints(6, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JLabel label2 = new JLabel();
        label2.setText("Input argument flag (Case Sensitive)");
    ...
    private void onChange() {
        ...
        if (!Utils.isEmpty(addressText)) {
            instance.setUrl(addressText);
        }
        String flag = customFlag.getText();
    ...
    public void setCustomFlag(String flag) {
        customFlag.setText(flag);
    }
